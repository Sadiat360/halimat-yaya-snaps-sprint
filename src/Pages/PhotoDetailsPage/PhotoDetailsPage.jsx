...
function PhotoDetailsPage(){
   ...
   console.log("PhotoDetailspage photoId:", params.photoId); ////reomove console
   
   useEffect(() =>{
      async function getPhotoDetails() { 
         const response = await axios.get(
             `https://unit-3-project-c5faaab51857.herokuapp.com/photos/${params.photoId}/?api_key=019425bb-7b53-4fc1-b033-f24347776ef9`
         );
   ...
   // const photo = photosData.find((photo) => photo.id === (photoId));
        ...
        <>
         ...
         <section className='single-Photo'>
             ...
             <figure className='single-Photo__box'>
              <img className='single-Photo__image' src= {photoDetails.photo} alt='image'/>
           ...
           <div className='single-Photo__container'>
                 ...
                 <ul className='single-Photo__tags'>
                  ...
                  <ul className='single-Photo__deets'>
                     ...
                     <li className='single-Photo__icon'><svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                               ...
                               {photoDetails.likes} likes</li>
                     <li className='single-Photo__date'>{photoDetails.timestamp}</li>
                  </ul>
